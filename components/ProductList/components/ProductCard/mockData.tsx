export interface IMockProduct {
  ...
  condition: EProductConditionEnum
  cover: EProductCoverEnum
}
...
export interface IMockOrder {
  ...
  description: string
  dueDate: Date
  productList: IMockProduct[]
}

export enum EProductStatusEnum {
  AVAILABLE = 'available',
...
export enum EProductCoverEnum {
  SOFT = 'soft',
  HARD = 'hard'
}

export enum EProductConditionEnum {
  NEW = 'new',
  OLD = 'old',
  DAMAGED = 'damaged'
}
...
export const MockProductConditions = Object.values(EProductConditionEnum)
export const MockProductCovers = Object.values(EProductCoverEnum)
...
export const mockProducts: IMockProduct[] = [
  {
    ...
    categories: [
      {
        name: 'horror',
        image: 'https://edit.org/images/cat/product-covers-big-2019101610.jpg'
      },
      {
        name: 'manga',
        image: 'https://edit.org/images/cat/product-covers-big-2019101610.jpg'
    ...
    condition: EProductConditionEnum.NEW,
    cover: EProductCoverEnum.HARD
  },
  {
    _id: '2',
    title: 'My Product',
    ...
    imageUrl: 'https://edit.org/images/cat/product-covers-big-2019101610.jpg',
    categories: [
      {
        name: 'textproduct',
        image: 'https://edit.org/images/cat/product-covers-big-2019101610.jpg'
    ...
    condition: EProductConditionEnum.DAMAGED,
    cover: EProductCoverEnum.SOFT
  },
  {
    _id: '3',
  ...
  },
  {
    ...
    condition: EProductConditionEnum.OLD,
    cover: EProductCoverEnum.SOFT
  },
  {
    _id: '9',
...
export const mockOrder: IMockOrder = {
  ...
  totalPrice: 10000,
  description: '',
  productList: [mockProducts[0], mockProducts[2], mockProducts[4]],
  userId: '1',
  dueDate: new Date()
}
...
export const mockCategories: IMockCategory[] = [
  ...
  {
    name: 'detective',
    image: 'https://beetifulproductcovers.com/wp-content/uploads/2017/10/LondonDetective.jpg'
  },
  {
    name: 'manga',
